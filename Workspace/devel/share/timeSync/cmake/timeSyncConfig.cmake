...
if("TRUE" STREQUAL "TRUE")
  set(timeSync_SOURCE_PREFIX /home/archielee/adVentuRe/Workspace/src/timeSync)
  set(timeSync_DEVEL_PREFIX /home/archielee/adVentuRe/Workspace/devel)
  set(timeSync_INSTALL_PREFIX "")
  set(timeSync_PREFIX ${timeSync_DEVEL_PREFIX})
else()
  set(timeSync_SOURCE_PREFIX "")
  set(timeSync_DEVEL_PREFIX "")
  set(timeSync_INSTALL_PREFIX /home/archielee/adVentuRe/Workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'timeSync' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/archielee/adVentuRe/Workspace/src/timeSync/${idir}'.  Ask the maintainer 'archielee <archielee@todo.todo>' to fix it.")
    endif()
